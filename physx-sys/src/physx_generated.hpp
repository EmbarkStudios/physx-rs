...
extern "C" {
    ...
    physx_PxCookingParams_Pod const* PxCooking_getParams(physx_PxCooking_Pod const* self__pod) {
        ...
        physx::PxCookingParams const& return_val = self_->getParams();
        auto return_val_pod = reinterpret_cast<physx_PxCookingParams_Pod const*>(&return_val);
        return return_val_pod;
    }

    bool PxCooking_platformMismatch(physx_PxCooking_Pod const* self__pod) {
        physx::PxCooking const* self_ = reinterpret_cast<physx::PxCooking const*>(self__pod);
        bool return_val = self_->platformMismatch();
        return return_val;
    }

    bool PxCooking_cookTriangleMesh(physx_PxCooking_Pod const* self__pod, physx_PxTriangleMeshDesc_Pod const* desc_pod, physx_PxOutputStream_Pod* stream_pod, int32_t* condition_pod) {
        physx::PxCooking const* self_ = reinterpret_cast<physx::PxCooking const*>(self__pod);
        ...
        bool return_val = self_->cookTriangleMesh(desc, stream, condition);
        return return_val;
    }

    physx_PxTriangleMesh_Pod* PxCooking_createTriangleMesh(physx_PxCooking_Pod const* self__pod, physx_PxTriangleMeshDesc_Pod const* desc_pod, physx_PxInsertionCallback_Pod* insertionCallback_pod, int32_t* condition_pod) {
        physx::PxCooking const* self_ = reinterpret_cast<physx::PxCooking const*>(self__pod);
        physx::PxTriangleMeshDesc const& desc = reinterpret_cast<physx::PxTriangleMeshDesc const&>(*desc_pod);
        physx::PxInsertionCallback& insertionCallback = reinterpret_cast<physx::PxInsertionCallback&>(*insertionCallback_pod);
        physx::PxTriangleMeshCookingResult::Enum* condition = reinterpret_cast<physx::PxTriangleMeshCookingResult::Enum*>(condition_pod);
        physx::PxTriangleMesh* return_val = self_->createTriangleMesh(desc, insertionCallback, condition);
        auto return_val_pod = reinterpret_cast<physx_PxTriangleMesh_Pod*>(return_val);
        return return_val_pod;
    }

    physx_PxTriangleMesh_Pod* PxCooking_createTriangleMesh_1(physx_PxCooking_Pod const* self__pod, physx_PxTriangleMeshDesc_Pod const* desc_pod) {
        physx::PxCooking const* self_ = reinterpret_cast<physx::PxCooking const*>(self__pod);
        physx::PxTriangleMeshDesc const& desc = reinterpret_cast<physx::PxTriangleMeshDesc const&>(*desc_pod);
        physx::PxTriangleMesh* return_val = self_->createTriangleMesh(desc);
        auto return_val_pod = reinterpret_cast<physx_PxTriangleMesh_Pod*>(return_val);
        return return_val_pod;
    }
    ...
    bool PxCooking_validateTriangleMesh(physx_PxCooking_Pod const* self__pod, physx_PxTriangleMeshDesc_Pod const* desc_pod) {
        physx::PxCooking const* self_ = reinterpret_cast<physx::PxCooking const*>(self__pod);
        physx::PxTriangleMeshDesc const& desc = reinterpret_cast<physx::PxTriangleMeshDesc const&>(*desc_pod);
        bool return_val = self_->validateTriangleMesh(desc);
        return return_val;
    }

    bool PxCooking_cookSoftBodyMesh(physx_PxCooking_Pod const* self__pod, physx_PxTetrahedronMeshDesc_Pod const* simulationMeshDesc_pod, physx_PxTetrahedronMeshDesc_Pod const* collisionMeshDesc_pod, physx_PxSoftBodySimulationDataDesc_Pod const* softbodyDataDesc_pod, physx_PxOutputStream_Pod* stream_pod) {
        physx::PxCooking const* self_ = reinterpret_cast<physx::PxCooking const*>(self__pod);
        physx::PxTetrahedronMeshDesc const& simulationMeshDesc = reinterpret_cast<physx::PxTetrahedronMeshDesc const&>(*simulationMeshDesc_pod);
        physx::PxTetrahedronMeshDesc const& collisionMeshDesc = reinterpret_cast<physx::PxTetrahedronMeshDesc const&>(*collisionMeshDesc_pod);
        physx::PxSoftBodySimulationDataDesc const& softbodyDataDesc = reinterpret_cast<physx::PxSoftBodySimulationDataDesc const&>(*softbodyDataDesc_pod);
        physx::PxOutputStream& stream = reinterpret_cast<physx::PxOutputStream&>(*stream_pod);
        bool return_val = self_->cookSoftBodyMesh(simulationMeshDesc, collisionMeshDesc, softbodyDataDesc, stream);
        return return_val;
    }

    physx_PxSoftBodyMesh_Pod* PxCooking_createSoftBodyMesh(physx_PxCooking_Pod const* self__pod, physx_PxTetrahedronMeshDesc_Pod const* simulationMeshDesc_pod, physx_PxTetrahedronMeshDesc_Pod const* collisionMeshDesc_pod, physx_PxSoftBodySimulationDataDesc_Pod const* softbodyDataDesc_pod, physx_PxInsertionCallback_Pod* insertionCallback_pod) {
        physx::PxCooking const* self_ = reinterpret_cast<physx::PxCooking const*>(self__pod);
        physx::PxTetrahedronMeshDesc const& simulationMeshDesc = reinterpret_cast<physx::PxTetrahedronMeshDesc const&>(*simulationMeshDesc_pod);
        physx::PxTetrahedronMeshDesc const& collisionMeshDesc = reinterpret_cast<physx::PxTetrahedronMeshDesc const&>(*collisionMeshDesc_pod);
        physx::PxSoftBodySimulationDataDesc const& softbodyDataDesc = reinterpret_cast<physx::PxSoftBodySimulationDataDesc const&>(*softbodyDataDesc_pod);
        physx::PxInsertionCallback& insertionCallback = reinterpret_cast<physx::PxInsertionCallback&>(*insertionCallback_pod);
        physx::PxSoftBodyMesh* return_val = self_->createSoftBodyMesh(simulationMeshDesc, collisionMeshDesc, softbodyDataDesc, insertionCallback);
        auto return_val_pod = reinterpret_cast<physx_PxSoftBodyMesh_Pod*>(return_val);
        return return_val_pod;
    }

    physx_PxSoftBodyMesh_Pod* PxCooking_createSoftBodyMesh_1(physx_PxCooking_Pod const* self__pod, physx_PxTetrahedronMeshDesc_Pod const* simulationMeshDesc_pod, physx_PxTetrahedronMeshDesc_Pod const* collisionMeshDesc_pod, physx_PxSoftBodySimulationDataDesc_Pod const* softbodyDataDesc_pod) {
        physx::PxCooking const* self_ = reinterpret_cast<physx::PxCooking const*>(self__pod);
        physx::PxTetrahedronMeshDesc const& simulationMeshDesc = reinterpret_cast<physx::PxTetrahedronMeshDesc const&>(*simulationMeshDesc_pod);
        physx::PxTetrahedronMeshDesc const& collisionMeshDesc = reinterpret_cast<physx::PxTetrahedronMeshDesc const&>(*collisionMeshDesc_pod);
        physx::PxSoftBodySimulationDataDesc const& softbodyDataDesc = reinterpret_cast<physx::PxSoftBodySimulationDataDesc const&>(*softbodyDataDesc_pod);
        physx::PxSoftBodyMesh* return_val = self_->createSoftBodyMesh(simulationMeshDesc, collisionMeshDesc, softbodyDataDesc);
        auto return_val_pod = reinterpret_cast<physx_PxSoftBodyMesh_Pod*>(return_val);
        return return_val_pod;
    }

    bool PxCooking_cookTetrahedronMesh(physx_PxCooking_Pod const* self__pod, physx_PxTetrahedronMeshDesc_Pod const* meshDesc_pod, physx_PxOutputStream_Pod* stream_pod) {
        physx::PxCooking const* self_ = reinterpret_cast<physx::PxCooking const*>(self__pod);
        physx::PxTetrahedronMeshDesc const& meshDesc = reinterpret_cast<physx::PxTetrahedronMeshDesc const&>(*meshDesc_pod);
        physx::PxOutputStream& stream = reinterpret_cast<physx::PxOutputStream&>(*stream_pod);
        bool return_val = self_->cookTetrahedronMesh(meshDesc, stream);
        return return_val;
    }

    physx_PxTetrahedronMesh_Pod* PxCooking_createTetrahedronMesh(physx_PxCooking_Pod const* self__pod, physx_PxTetrahedronMeshDesc_Pod const* meshDesc_pod, physx_PxInsertionCallback_Pod* insertionCallback_pod) {
        physx::PxCooking const* self_ = reinterpret_cast<physx::PxCooking const*>(self__pod);
        physx::PxTetrahedronMeshDesc const& meshDesc = reinterpret_cast<physx::PxTetrahedronMeshDesc const&>(*meshDesc_pod);
        physx::PxInsertionCallback& insertionCallback = reinterpret_cast<physx::PxInsertionCallback&>(*insertionCallback_pod);
        physx::PxTetrahedronMesh* return_val = self_->createTetrahedronMesh(meshDesc, insertionCallback);
        auto return_val_pod = reinterpret_cast<physx_PxTetrahedronMesh_Pod*>(return_val);
        return return_val_pod;
    }

    physx_PxTetrahedronMesh_Pod* PxCooking_createTetrahedronMesh_1(physx_PxCooking_Pod const* self__pod, physx_PxTetrahedronMeshDesc_Pod const* meshDesc_pod) {
        physx::PxCooking const* self_ = reinterpret_cast<physx::PxCooking const*>(self__pod);
        physx::PxTetrahedronMeshDesc const& meshDesc = reinterpret_cast<physx::PxTetrahedronMeshDesc const&>(*meshDesc_pod);
        physx::PxTetrahedronMesh* return_val = self_->createTetrahedronMesh(meshDesc);
        auto return_val_pod = reinterpret_cast<physx_PxTetrahedronMesh_Pod*>(return_val);
        return return_val_pod;
    }

    physx_PxCollisionMeshMappingData_Pod* PxCooking_computeModelsMapping(physx_PxCooking_Pod const* self__pod, physx_PxTetrahedronMeshData_Pod* simulationMesh_pod, physx_PxTetrahedronMeshData_Pod const* collisionMesh_pod, physx_PxSoftBodyCollisionData_Pod const* collisionData_pod, physx_PxBoundedData_Pod const* vertexToTet_pod) {
        physx::PxCooking const* self_ = reinterpret_cast<physx::PxCooking const*>(self__pod);
        physx::PxTetrahedronMeshData& simulationMesh = reinterpret_cast<physx::PxTetrahedronMeshData&>(*simulationMesh_pod);
        physx::PxTetrahedronMeshData const& collisionMesh = reinterpret_cast<physx::PxTetrahedronMeshData const&>(*collisionMesh_pod);
        physx::PxSoftBodyCollisionData const& collisionData = reinterpret_cast<physx::PxSoftBodyCollisionData const&>(*collisionData_pod);
        physx::PxBoundedData const* vertexToTet = reinterpret_cast<physx::PxBoundedData const*>(vertexToTet_pod);
        physx::PxCollisionMeshMappingData* return_val = self_->computeModelsMapping(simulationMesh, collisionMesh, collisionData, vertexToTet);
        auto return_val_pod = reinterpret_cast<physx_PxCollisionMeshMappingData_Pod*>(return_val);
        return return_val_pod;
    }

    physx_PxCollisionTetrahedronMeshData_Pod* PxCooking_computeCollisionData(physx_PxCooking_Pod const* self__pod, physx_PxTetrahedronMeshDesc_Pod const* collisionMeshDesc_pod) {
        physx::PxCooking const* self_ = reinterpret_cast<physx::PxCooking const*>(self__pod);
        physx::PxTetrahedronMeshDesc const& collisionMeshDesc = reinterpret_cast<physx::PxTetrahedronMeshDesc const&>(*collisionMeshDesc_pod);
        physx::PxCollisionTetrahedronMeshData* return_val = self_->computeCollisionData(collisionMeshDesc);
        auto return_val_pod = reinterpret_cast<physx_PxCollisionTetrahedronMeshData_Pod*>(return_val);
        return return_val_pod;
    }

    physx_PxSimulationTetrahedronMeshData_Pod* PxCooking_computeSimulationData(physx_PxCooking_Pod const* self__pod, physx_PxTetrahedronMeshDesc_Pod const* simulationMeshDesc_pod) {
        physx::PxCooking const* self_ = reinterpret_cast<physx::PxCooking const*>(self__pod);
        physx::PxTetrahedronMeshDesc const& simulationMeshDesc = reinterpret_cast<physx::PxTetrahedronMeshDesc const&>(*simulationMeshDesc_pod);
        physx::PxSimulationTetrahedronMeshData* return_val = self_->computeSimulationData(simulationMeshDesc);
        auto return_val_pod = reinterpret_cast<physx_PxSimulationTetrahedronMeshData_Pod*>(return_val);
        return return_val_pod;
    }

    physx_PxSoftBodyMesh_Pod* PxCooking_assembleSoftBodyMesh(physx_PxCooking_Pod const* self__pod, physx_PxTetrahedronMeshData_Pod* simulationMesh_pod, physx_PxSoftBodySimulationData_Pod* simulationData_pod, physx_PxTetrahedronMeshData_Pod* collisionMesh_pod, physx_PxSoftBodyCollisionData_Pod* collisionData_pod, physx_PxCollisionMeshMappingData_Pod* mappingData_pod, physx_PxInsertionCallback_Pod* insertionCallback_pod) {
        physx::PxCooking const* self_ = reinterpret_cast<physx::PxCooking const*>(self__pod);
        physx::PxTetrahedronMeshData& simulationMesh = reinterpret_cast<physx::PxTetrahedronMeshData&>(*simulationMesh_pod);
        physx::PxSoftBodySimulationData& simulationData = reinterpret_cast<physx::PxSoftBodySimulationData&>(*simulationData_pod);
        physx::PxTetrahedronMeshData& collisionMesh = reinterpret_cast<physx::PxTetrahedronMeshData&>(*collisionMesh_pod);
        physx::PxSoftBodyCollisionData& collisionData = reinterpret_cast<physx::PxSoftBodyCollisionData&>(*collisionData_pod);
        physx::PxCollisionMeshMappingData& mappingData = reinterpret_cast<physx::PxCollisionMeshMappingData&>(*mappingData_pod);
        physx::PxInsertionCallback& insertionCallback = reinterpret_cast<physx::PxInsertionCallback&>(*insertionCallback_pod);
        physx::PxSoftBodyMesh* return_val = self_->assembleSoftBodyMesh(simulationMesh, simulationData, collisionMesh, collisionData, mappingData, insertionCallback);
        auto return_val_pod = reinterpret_cast<physx_PxSoftBodyMesh_Pod*>(return_val);
        return return_val_pod;
    }

    physx_PxSoftBodyMesh_Pod* PxCooking_assembleSoftBodyMesh_1(physx_PxCooking_Pod const* self__pod, physx_PxSimulationTetrahedronMeshData_Pod* simulationMesh_pod, physx_PxCollisionTetrahedronMeshData_Pod* collisionMesh_pod, physx_PxCollisionMeshMappingData_Pod* mappingData_pod, physx_PxInsertionCallback_Pod* insertionCallback_pod) {
        physx::PxCooking const* self_ = reinterpret_cast<physx::PxCooking const*>(self__pod);
        physx::PxSimulationTetrahedronMeshData& simulationMesh = reinterpret_cast<physx::PxSimulationTetrahedronMeshData&>(*simulationMesh_pod);
        physx::PxCollisionTetrahedronMeshData& collisionMesh = reinterpret_cast<physx::PxCollisionTetrahedronMeshData&>(*collisionMesh_pod);
        physx::PxCollisionMeshMappingData& mappingData = reinterpret_cast<physx::PxCollisionMeshMappingData&>(*mappingData_pod);
        physx::PxInsertionCallback& insertionCallback = reinterpret_cast<physx::PxInsertionCallback&>(*insertionCallback_pod);
        physx::PxSoftBodyMesh* return_val = self_->assembleSoftBodyMesh(simulationMesh, collisionMesh, mappingData, insertionCallback);
        auto return_val_pod = reinterpret_cast<physx_PxSoftBodyMesh_Pod*>(return_val);
        return return_val_pod;
    }

    bool PxCooking_cookConvexMesh(physx_PxCooking_Pod const* self__pod, physx_PxConvexMeshDesc_Pod const* desc_pod, physx_PxOutputStream_Pod* stream_pod, int32_t* condition_pod) {
        physx::PxCooking const* self_ = reinterpret_cast<physx::PxCooking const*>(self__pod);
        ...
        bool return_val = self_->cookConvexMesh(desc, stream, condition);
        return return_val;
    }

    physx_PxConvexMesh_Pod* PxCooking_createConvexMesh(physx_PxCooking_Pod const* self__pod, physx_PxConvexMeshDesc_Pod const* desc_pod, physx_PxInsertionCallback_Pod* insertionCallback_pod, int32_t* condition_pod) {
        physx::PxCooking const* self_ = reinterpret_cast<physx::PxCooking const*>(self__pod);
        physx::PxConvexMeshDesc const& desc = reinterpret_cast<physx::PxConvexMeshDesc const&>(*desc_pod);
        physx::PxInsertionCallback& insertionCallback = reinterpret_cast<physx::PxInsertionCallback&>(*insertionCallback_pod);
        physx::PxConvexMeshCookingResult::Enum* condition = reinterpret_cast<physx::PxConvexMeshCookingResult::Enum*>(condition_pod);
        physx::PxConvexMesh* return_val = self_->createConvexMesh(desc, insertionCallback, condition);
        auto return_val_pod = reinterpret_cast<physx_PxConvexMesh_Pod*>(return_val);
        return return_val_pod;
    }

    physx_PxConvexMesh_Pod* PxCooking_createConvexMesh_1(physx_PxCooking_Pod const* self__pod, physx_PxConvexMeshDesc_Pod const* desc_pod) {
        physx::PxCooking const* self_ = reinterpret_cast<physx::PxCooking const*>(self__pod);
        physx::PxConvexMeshDesc const& desc = reinterpret_cast<physx::PxConvexMeshDesc const&>(*desc_pod);
        physx::PxConvexMesh* return_val = self_->createConvexMesh(desc);
        auto return_val_pod = reinterpret_cast<physx_PxConvexMesh_Pod*>(return_val);
        return return_val_pod;
    }
    ...
    bool PxCooking_validateConvexMesh(physx_PxCooking_Pod const* self__pod, physx_PxConvexMeshDesc_Pod const* desc_pod) {
        physx::PxCooking const* self_ = reinterpret_cast<physx::PxCooking const*>(self__pod);
        physx::PxConvexMeshDesc const& desc = reinterpret_cast<physx::PxConvexMeshDesc const&>(*desc_pod);
        bool return_val = self_->validateConvexMesh(desc);
        return return_val;
    }
    ...
    bool PxCooking_computeHullPolygons(physx_PxCooking_Pod const* self__pod, physx_PxSimpleTriangleMesh_Pod const* mesh_pod, physx_PxAllocatorCallback_Pod* inCallback_pod, uint32_t* nbVerts_pod, physx_PxVec3_Pod** vertices_pod, uint32_t* nbIndices_pod, uint32_t** indices_pod, uint32_t* nbPolygons_pod, physx_PxHullPolygon_Pod** hullPolygons_pod) {
        ...
        bool return_val = self_->computeHullPolygons(mesh, inCallback, nbVerts, vertices, nbIndices, indices, nbPolygons, hullPolygons);
        return return_val;
    }
    ...
    bool PxCooking_cookHeightField(physx_PxCooking_Pod const* self__pod, physx_PxHeightFieldDesc_Pod const* desc_pod, physx_PxOutputStream_Pod* stream_pod) {
        ...
        physx::PxOutputStream& stream = reinterpret_cast<physx::PxOutputStream&>(*stream_pod);
        bool return_val = self_->cookHeightField(desc, stream);
        return return_val;
    }

    physx_PxHeightField_Pod* PxCooking_createHeightField(physx_PxCooking_Pod const* self__pod, physx_PxHeightFieldDesc_Pod const* desc_pod, physx_PxInsertionCallback_Pod* insertionCallback_pod) {
        physx::PxCooking const* self_ = reinterpret_cast<physx::PxCooking const*>(self__pod);
        physx::PxHeightFieldDesc const& desc = reinterpret_cast<physx::PxHeightFieldDesc const&>(*desc_pod);
        physx::PxInsertionCallback& insertionCallback = reinterpret_cast<physx::PxInsertionCallback&>(*insertionCallback_pod);
        physx::PxHeightField* return_val = self_->createHeightField(desc, insertionCallback);
        auto return_val_pod = reinterpret_cast<physx_PxHeightField_Pod*>(return_val);
        return return_val_pod;
    }

    physx_PxHeightField_Pod* PxCooking_createHeightField_1(physx_PxCooking_Pod const* self__pod, physx_PxHeightFieldDesc_Pod const* desc_pod) {
        physx::PxCooking const* self_ = reinterpret_cast<physx::PxCooking const*>(self__pod);
        physx::PxHeightFieldDesc const& desc = reinterpret_cast<physx::PxHeightFieldDesc const&>(*desc_pod);
        physx::PxHeightField* return_val = self_->createHeightField(desc);
        auto return_val_pod = reinterpret_cast<physx_PxHeightField_Pod*>(return_val);
        return return_val_pod;
    }

    bool PxCooking_cookBVH(physx_PxCooking_Pod const* self__pod, physx_PxBVHDesc_Pod const* desc_pod, physx_PxOutputStream_Pod* stream_pod) {
        physx::PxCooking const* self_ = reinterpret_cast<physx::PxCooking const*>(self__pod);
        physx::PxBVHDesc const& desc = reinterpret_cast<physx::PxBVHDesc const&>(*desc_pod);
        physx::PxOutputStream& stream = reinterpret_cast<physx::PxOutputStream&>(*stream_pod);
        bool return_val = self_->cookBVH(desc, stream);
        return return_val;
    }

    physx_PxBVH_Pod* PxCooking_createBVH(physx_PxCooking_Pod const* self__pod, physx_PxBVHDesc_Pod const* desc_pod, physx_PxInsertionCallback_Pod* insertionCallback_pod) {
        physx::PxCooking const* self_ = reinterpret_cast<physx::PxCooking const*>(self__pod);
        physx::PxBVHDesc const& desc = reinterpret_cast<physx::PxBVHDesc const&>(*desc_pod);
        physx::PxInsertionCallback& insertionCallback = reinterpret_cast<physx::PxInsertionCallback&>(*insertionCallback_pod);
        physx::PxBVH* return_val = self_->createBVH(desc, insertionCallback);
        auto return_val_pod = reinterpret_cast<physx_PxBVH_Pod*>(return_val);
        return return_val_pod;
    }

    physx_PxBVH_Pod* PxCooking_createBVH_1(physx_PxCooking_Pod const* self__pod, physx_PxBVHDesc_Pod const* desc_pod) {
        physx::PxCooking const* self_ = reinterpret_cast<physx::PxCooking const*>(self__pod);
        physx::PxBVHDesc const& desc = reinterpret_cast<physx::PxBVHDesc const&>(*desc_pod);
        physx::PxBVH* return_val = self_->createBVH(desc);
        auto return_val_pod = reinterpret_cast<physx_PxBVH_Pod*>(return_val);
        return return_val_pod;
    }

    physx_PxInsertionCallback_Pod* PxCooking_getStandaloneInsertionCallback_mut(physx_PxCooking_Pod* self__pod) {
        physx::PxCooking* self_ = reinterpret_cast<physx::PxCooking*>(self__pod);
        physx::PxInsertionCallback& return_val = self_->getStandaloneInsertionCallback();
        auto return_val_pod = reinterpret_cast<physx_PxInsertionCallback_Pod*>(&return_val);
        return return_val_pod;
    }
    ...
    physx_PxCooking_Pod* phys_PxCreateCooking(uint32_t version, physx_PxFoundation_Pod* foundation_pod, physx_PxCookingParams_Pod const* params_pod) {
        physx::PxFoundation& foundation = reinterpret_cast<physx::PxFoundation&>(*foundation_pod);
        physx::PxCookingParams const& params = reinterpret_cast<physx::PxCookingParams const&>(*params_pod);
        physx::PxCooking* return_val = PxCreateCooking(version, foundation, params);
        auto return_val_pod = reinterpret_cast<physx_PxCooking_Pod*>(return_val);
        return return_val_pod;
    }
    ...
    bool phys_PxCookTetrahedronMesh(physx_PxCookingParams_Pod const* params_pod, physx_PxTetrahedronMeshDesc_Pod const* meshDesc_pod, physx_PxOutputStream_Pod* stream_pod) {
        physx::PxCookingParams const& params = reinterpret_cast<physx::PxCookingParams const&>(*params_pod);
        physx::PxTetrahedronMeshDesc const& meshDesc = reinterpret_cast<physx::PxTetrahedronMeshDesc const&>(*meshDesc_pod);
        physx::PxOutputStream& stream = reinterpret_cast<physx::PxOutputStream&>(*stream_pod);
        bool return_val = PxCookTetrahedronMesh(params, meshDesc, stream);
        return return_val;
    }

    physx_PxTetrahedronMesh_Pod* phys_PxCreateTetrahedronMesh(physx_PxCookingParams_Pod const* params_pod, physx_PxTetrahedronMeshDesc_Pod const* meshDesc_pod, physx_PxInsertionCallback_Pod* insertionCallback_pod) {
        physx::PxCookingParams const& params = reinterpret_cast<physx::PxCookingParams const&>(*params_pod);
        physx::PxTetrahedronMeshDesc const& meshDesc = reinterpret_cast<physx::PxTetrahedronMeshDesc const&>(*meshDesc_pod);
        physx::PxInsertionCallback& insertionCallback = reinterpret_cast<physx::PxInsertionCallback&>(*insertionCallback_pod);
        physx::PxTetrahedronMesh* return_val = PxCreateTetrahedronMesh(params, meshDesc, insertionCallback);
        auto return_val_pod = reinterpret_cast<physx_PxTetrahedronMesh_Pod*>(return_val);
        return return_val_pod;
    }

    bool phys_PxCookSoftBodyMesh(physx_PxCookingParams_Pod const* params_pod, physx_PxTetrahedronMeshDesc_Pod const* simulationMeshDesc_pod, physx_PxTetrahedronMeshDesc_Pod const* collisionMeshDesc_pod, physx_PxSoftBodySimulationDataDesc_Pod const* softbodyDataDesc_pod, physx_PxOutputStream_Pod* stream_pod) {
        physx::PxCookingParams const& params = reinterpret_cast<physx::PxCookingParams const&>(*params_pod);
        physx::PxTetrahedronMeshDesc const& simulationMeshDesc = reinterpret_cast<physx::PxTetrahedronMeshDesc const&>(*simulationMeshDesc_pod);
        physx::PxTetrahedronMeshDesc const& collisionMeshDesc = reinterpret_cast<physx::PxTetrahedronMeshDesc const&>(*collisionMeshDesc_pod);
        physx::PxSoftBodySimulationDataDesc const& softbodyDataDesc = reinterpret_cast<physx::PxSoftBodySimulationDataDesc const&>(*softbodyDataDesc_pod);
        physx::PxOutputStream& stream = reinterpret_cast<physx::PxOutputStream&>(*stream_pod);
        bool return_val = PxCookSoftBodyMesh(params, simulationMeshDesc, collisionMeshDesc, softbodyDataDesc, stream);
        return return_val;
    }

    physx_PxSoftBodyMesh_Pod* phys_PxCreateSoftBodyMesh(physx_PxCookingParams_Pod const* params_pod, physx_PxTetrahedronMeshDesc_Pod const* simulationMeshDesc_pod, physx_PxTetrahedronMeshDesc_Pod const* collisionMeshDesc_pod, physx_PxSoftBodySimulationDataDesc_Pod const* softbodyDataDesc_pod, physx_PxInsertionCallback_Pod* insertionCallback_pod) {
        physx::PxCookingParams const& params = reinterpret_cast<physx::PxCookingParams const&>(*params_pod);
        physx::PxTetrahedronMeshDesc const& simulationMeshDesc = reinterpret_cast<physx::PxTetrahedronMeshDesc const&>(*simulationMeshDesc_pod);
        physx::PxTetrahedronMeshDesc const& collisionMeshDesc = reinterpret_cast<physx::PxTetrahedronMeshDesc const&>(*collisionMeshDesc_pod);
        physx::PxSoftBodySimulationDataDesc const& softbodyDataDesc = reinterpret_cast<physx::PxSoftBodySimulationDataDesc const&>(*softbodyDataDesc_pod);
        physx::PxInsertionCallback& insertionCallback = reinterpret_cast<physx::PxInsertionCallback&>(*insertionCallback_pod);
        physx::PxSoftBodyMesh* return_val = PxCreateSoftBodyMesh(params, simulationMeshDesc, collisionMeshDesc, softbodyDataDesc, insertionCallback);
        auto return_val_pod = reinterpret_cast<physx_PxSoftBodyMesh_Pod*>(return_val);
        return return_val_pod;
    }

    physx_PxCollisionMeshMappingData_Pod* phys_PxComputeModelsMapping(physx_PxCookingParams_Pod const* params_pod, physx_PxTetrahedronMeshData_Pod* simulationMesh_pod, physx_PxTetrahedronMeshData_Pod const* collisionMesh_pod, physx_PxSoftBodyCollisionData_Pod const* collisionData_pod, physx_PxBoundedData_Pod const* vertexToTet_pod) {
        physx::PxCookingParams const& params = reinterpret_cast<physx::PxCookingParams const&>(*params_pod);
        physx::PxTetrahedronMeshData& simulationMesh = reinterpret_cast<physx::PxTetrahedronMeshData&>(*simulationMesh_pod);
        physx::PxTetrahedronMeshData const& collisionMesh = reinterpret_cast<physx::PxTetrahedronMeshData const&>(*collisionMesh_pod);
        physx::PxSoftBodyCollisionData const& collisionData = reinterpret_cast<physx::PxSoftBodyCollisionData const&>(*collisionData_pod);
        physx::PxBoundedData const* vertexToTet = reinterpret_cast<physx::PxBoundedData const*>(vertexToTet_pod);
        physx::PxCollisionMeshMappingData* return_val = PxComputeModelsMapping(params, simulationMesh, collisionMesh, collisionData, vertexToTet);
        auto return_val_pod = reinterpret_cast<physx_PxCollisionMeshMappingData_Pod*>(return_val);
        return return_val_pod;
    }

    physx_PxCollisionTetrahedronMeshData_Pod* phys_PxComputeCollisionData(physx_PxCookingParams_Pod const* params_pod, physx_PxTetrahedronMeshDesc_Pod const* collisionMeshDesc_pod) {
        physx::PxCookingParams const& params = reinterpret_cast<physx::PxCookingParams const&>(*params_pod);
        physx::PxTetrahedronMeshDesc const& collisionMeshDesc = reinterpret_cast<physx::PxTetrahedronMeshDesc const&>(*collisionMeshDesc_pod);
        physx::PxCollisionTetrahedronMeshData* return_val = PxComputeCollisionData(params, collisionMeshDesc);
        auto return_val_pod = reinterpret_cast<physx_PxCollisionTetrahedronMeshData_Pod*>(return_val);
        return return_val_pod;
    }

    physx_PxSimulationTetrahedronMeshData_Pod* phys_PxComputeSimulationData(physx_PxCookingParams_Pod const* params_pod, physx_PxTetrahedronMeshDesc_Pod const* simulationMeshDesc_pod) {
        physx::PxCookingParams const& params = reinterpret_cast<physx::PxCookingParams const&>(*params_pod);
        physx::PxTetrahedronMeshDesc const& simulationMeshDesc = reinterpret_cast<physx::PxTetrahedronMeshDesc const&>(*simulationMeshDesc_pod);
        physx::PxSimulationTetrahedronMeshData* return_val = PxComputeSimulationData(params, simulationMeshDesc);
        auto return_val_pod = reinterpret_cast<physx_PxSimulationTetrahedronMeshData_Pod*>(return_val);
        return return_val_pod;
    }

    physx_PxSoftBodyMesh_Pod* phys_PxAssembleSoftBodyMesh(physx_PxTetrahedronMeshData_Pod* simulationMesh_pod, physx_PxSoftBodySimulationData_Pod* simulationData_pod, physx_PxTetrahedronMeshData_Pod* collisionMesh_pod, physx_PxSoftBodyCollisionData_Pod* collisionData_pod, physx_PxCollisionMeshMappingData_Pod* mappingData_pod, physx_PxInsertionCallback_Pod* insertionCallback_pod) {
        physx::PxTetrahedronMeshData& simulationMesh = reinterpret_cast<physx::PxTetrahedronMeshData&>(*simulationMesh_pod);
        physx::PxSoftBodySimulationData& simulationData = reinterpret_cast<physx::PxSoftBodySimulationData&>(*simulationData_pod);
        physx::PxTetrahedronMeshData& collisionMesh = reinterpret_cast<physx::PxTetrahedronMeshData&>(*collisionMesh_pod);
        physx::PxSoftBodyCollisionData& collisionData = reinterpret_cast<physx::PxSoftBodyCollisionData&>(*collisionData_pod);
        physx::PxCollisionMeshMappingData& mappingData = reinterpret_cast<physx::PxCollisionMeshMappingData&>(*mappingData_pod);
        physx::PxInsertionCallback& insertionCallback = reinterpret_cast<physx::PxInsertionCallback&>(*insertionCallback_pod);
        physx::PxSoftBodyMesh* return_val = PxAssembleSoftBodyMesh(simulationMesh, simulationData, collisionMesh, collisionData, mappingData, insertionCallback);
        auto return_val_pod = reinterpret_cast<physx_PxSoftBodyMesh_Pod*>(return_val);
        return return_val_pod;
    }

    physx_PxSoftBodyMesh_Pod* phys_PxAssembleSoftBodyMesh_Sim(physx_PxSimulationTetrahedronMeshData_Pod* simulationMesh_pod, physx_PxCollisionTetrahedronMeshData_Pod* collisionMesh_pod, physx_PxCollisionMeshMappingData_Pod* mappingData_pod, physx_PxInsertionCallback_Pod* insertionCallback_pod) {
        physx::PxSimulationTetrahedronMeshData& simulationMesh = reinterpret_cast<physx::PxSimulationTetrahedronMeshData&>(*simulationMesh_pod);
        physx::PxCollisionTetrahedronMeshData& collisionMesh = reinterpret_cast<physx::PxCollisionTetrahedronMeshData&>(*collisionMesh_pod);
        physx::PxCollisionMeshMappingData& mappingData = reinterpret_cast<physx::PxCollisionMeshMappingData&>(*mappingData_pod);
        physx::PxInsertionCallback& insertionCallback = reinterpret_cast<physx::PxInsertionCallback&>(*insertionCallback_pod);
        physx::PxSoftBodyMesh* return_val = PxAssembleSoftBodyMesh_Sim(simulationMesh, collisionMesh, mappingData, insertionCallback);
        auto return_val_pod = reinterpret_cast<physx_PxSoftBodyMesh_Pod*>(return_val);
        return return_val_pod;
    }
