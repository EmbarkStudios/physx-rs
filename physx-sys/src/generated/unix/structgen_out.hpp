...
struct physx_PxSimulationStatistics_Pod {
    ...
    uint32_t nbDiscreteContactPairs[8][8];
    uint32_t nbCCDPairs[8][8];
    uint32_t nbModifiedContactPairs[8][8];
    uint32_t nbTriggerPairs[8][8];
};
