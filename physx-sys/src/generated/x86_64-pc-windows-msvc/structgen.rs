...
#[test] fn check_size_PxSweepHit() { assert_eq!(std::mem::size_of::<PxSweepHit>(), 64); }
#[derive(Clone, Copy)]
#[repr(C)]
...
#[test] fn check_size_PxOverlapHit() { assert_eq!(std::mem::size_of::<PxOverlapHit>(), 32); }
#[derive(Clone, Copy)]
#[repr(C)]
...
#[test] fn check_size_PxBoxControllerDesc() { assert_eq!(std::mem::size_of::<PxBoxControllerDesc>(), 152); }
#[derive(Clone, Copy)]
#[repr(C)]
...
#[test] fn check_size_PxCapsuleControllerDesc() { assert_eq!(std::mem::size_of::<PxCapsuleControllerDesc>(), 152); }
#[derive(Clone, Copy)]
#[repr(C)]
