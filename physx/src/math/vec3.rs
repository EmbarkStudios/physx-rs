...
impl PxVec3 {
    ...
    pub fn new(x: f32, y: f32, z: f32) -> PxVec3 {
        unsafe {
            PxVec3{obj: PxVec3_new_3(x, y, z)}
        }
    }

    pub fn abs(&self) -> PxVec3 {
        unsafe {
            PxVec3_abs(self.as_ptr()).into()
        }
    }

    pub fn cross(&self, other: &PxVec3) -> PxVec3 {
        unsafe {
            PxVec3_cross(self.as_ptr(), other.as_ptr()).into()
        }
    }

    pub fn dot(&self, other: &PxVec3) -> f32 {
        unsafe {
            PxVec3_dot(self.as_ptr(), other.as_ptr())
        }
    }

    pub fn get_normalized(&self) -> PxVec3 {
        unsafe {
            PxVec3_getNormalized(self.as_ptr()).into()
        }
    }

    pub fn is_finite(&self) -> bool {
        unsafe {
            PxVec3_isFinite(self.as_ptr())
        }
    }

    pub fn is_normalized(&self) -> bool {
        unsafe {
            PxVec3_isNormalized(self.as_ptr())
        }
    }

    pub fn is_zero(&self) -> bool {
        unsafe {
            PxVec3_isZero(self.as_ptr())
        }
    }

    pub fn magnitude(&self) -> f32 {
        unsafe {
            PxVec3_magnitude(self.as_ptr())
        }
    }

    pub fn magnitude_squared(&self) -> f32 {
        unsafe {
            PxVec3_magnitudeSquared(self.as_ptr())
        }
    }

    pub fn max_element(&self) -> f32 {
        unsafe {
            PxVec3_maxElement(self.as_ptr())
        }
    }

    pub fn maximum(&self, other: &PxVec3) -> PxVec3 {
        unsafe {
            PxVec3_maximum(self.as_ptr(), other.as_ptr()).into()
        }
    }

    pub fn min_element(&self) -> f32 {
        unsafe {
            PxVec3_minElement(self.as_ptr())
        }
    }

    pub fn minimum(&self, other: &PxVec3) -> PxVec3 {
        unsafe {
            PxVec3_minimum(self.as_ptr(), other.as_ptr()).into()
        }
    }

    pub fn multiply(&self, other: &PxVec3) -> PxVec3 {
        unsafe {
            PxVec3_multiply(self.as_ptr(), other.as_ptr()).into()
        }
    }
    ...
    pub fn normalize(&mut self) -> f32 {
        unsafe {
            PxVec3_normalize_mut(self.as_mut_ptr())
        }
    }
}
