    ...
    > SceneDescriptor<U, L, S, D, T, C, OC, OT, OCB, OWS, OA>
{
    pub fn new(user_data: U) -> Self {
        Self {
            ...
            kine_kine_filtering_mode: Default::default(),
            static_kine_filtering_mode: Default::default(),
            broad_phase_type: Default::default(),
            limits: Default::default(),
            friction_type: Default::default(),
            ...
            static_structure: Default::default(),
            dynamic_structure: Default::default(),
            dynamic_tree_rebuild_rate_hint: 100,
            scene_query_update_mode: Default::default(),
            ...
            sanity_bounds: Default::default(),
            simulation_filter_shader: Default::default(),
            thread_count: 1,
    ...
    fn create(self, creator: &mut P) -> Self::Target {
        let mut desc = unsafe {
            physx_sys::PxSceneDesc {
                ...
                limits: physx_sys::PxSceneLimits {
                    maxNbActors: self.limits.max_nb_actors,
                    maxNbBodies: self.limits.max_nb_bodies,
                    maxNbStaticShapes: self.limits.max_nb_static_shapes,
                    maxNbDynamicShapes: self.limits.max_nb_dynamic_shapes,
                    maxNbAggregates: self.limits.max_nb_aggregates,
                    maxNbConstraints: self.limits.max_nb_constraints,
                    maxNbRegions: self.limits.max_nb_regions,
                    maxNbBroadPhaseOverlaps: self.limits.max_nb_broad_phase_overlaps,
                },
