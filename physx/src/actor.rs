...
use crate::{
    articulation_link::ArticulationLink, base::Base, math::*, rigid_dynamic::RigidDynamic,
    rigid_static::RigidStatic, traits::Class,
};
...
unsafe impl<P, L, S, D, H, M> Class<P> for ActorMap<L, S, D, H, M>
where
